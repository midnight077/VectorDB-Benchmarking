...
class MinimaxHeap(object):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    n = property(_swigfaiss.MinimaxHeap_n_get, _swigfaiss.MinimaxHeap_n_set)
    k = property(_swigfaiss.MinimaxHeap_k_get, _swigfaiss.MinimaxHeap_k_set)
    nvalid = property(_swigfaiss.MinimaxHeap_nvalid_get, _swigfaiss.MinimaxHeap_nvalid_set)
    ids = property(_swigfaiss.MinimaxHeap_ids_get, _swigfaiss.MinimaxHeap_ids_set)
    dis = property(_swigfaiss.MinimaxHeap_dis_get, _swigfaiss.MinimaxHeap_dis_set)

    def __init__(self, n_in):
        _swigfaiss.MinimaxHeap_swiginit(self, _swigfaiss.new_MinimaxHeap(n_in))

    def push(self, i, v):
        return _swigfaiss.MinimaxHeap_push(self, i, v)

    def max(self):
        return _swigfaiss.MinimaxHeap_max(self)

    def size(self):
        return _swigfaiss.MinimaxHeap_size(self)

    def clear(self):
        return _swigfaiss.MinimaxHeap_clear(self)

    def pop_min(self, vmin_out=None):
        r"""
        Runtime-dispatched pop_min (calls pop_min_tpl with best available
        SIMD level).
        """
        return _swigfaiss.MinimaxHeap_pop_min(self, vmin_out)

    def count_below(self, thresh):
        return _swigfaiss.MinimaxHeap_count_below(self, thresh)
    __swig_destroy__ = _swigfaiss.delete_MinimaxHeap

# Register MinimaxHeap in _swigfaiss:
_swigfaiss.MinimaxHeap_swigregister(MinimaxHeap)
...
class VisitedTable(object):
    ...
    visited_set = property(_swigfaiss.VisitedTable_visited_set_get, _swigfaiss.VisitedTable_visited_set_set)
    visno = property(_swigfaiss.VisitedTable_visno_get, _swigfaiss.VisitedTable_visno_set)

    def __init__(self, *args):
        _swigfaiss.VisitedTable_swiginit(self, _swigfaiss.new_VisitedTable(*args))
    ...
    def reserve(self, n):
        ...
        return _swigfaiss.VisitedTable_reserve(self, n)
